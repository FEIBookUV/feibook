...
$uid = $cookie['uid'];
$CONFIG->uid = $uid;
$arr = fbconnect_get_info_from_fb('first_name, last_name, middle_name,email, pic_big');	   
$CONFIG->first_name = $arr['first_name'];
$CONFIG->middle_name = $arr['middle_name'];
...
?>
	...
	$('input[name="custom_profile_fields_Apellidos"]').val("<?php echo $CONFIG->middle_name." ".$CONFIG->last_name; ?>");
