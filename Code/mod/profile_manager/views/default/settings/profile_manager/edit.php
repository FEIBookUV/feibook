...
<table>
	...
	<tr>
		...
		<td>
			<select name="params[display_system_category]">
				<option value="yes" <?php if ($vars['entity']->display_system_category == 'yes') echo " selected=\"yes\" "; ?>><?php echo elgg_echo('option:yes'); ?></option>
				<option value="no" <?php if ($vars['entity']->display_system_category != 'yes') echo " selected=\"yes\" "; ?>><?php echo elgg_echo('option:no'); ?></option>
			</select>	
		</td>
	</tr>
	<tr>
...
<?php 
	echo "server time: " . strftime("%T", time()) . "<br />";
	echo "server time (based on locale): " . strftime("%X", time()) . "<br />";
	echo "client time: ";
?>
