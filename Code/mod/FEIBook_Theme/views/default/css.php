...
/* elgg open source		blue 			#000000 */
/* elgg open source		dark blue 		#000000 */
...
body {
 text-align:left;
    ...
    background: url('<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/body_bg1.jpg');
	background-attachment:	fixed;

}
a {
	color:#000000;   /* Settings y More info */
...
#wrapper_header #leaderboardHeader {
	width: 728px;
	height: 90px;
	padding-top: 10px;
	margin-left: 268px;
...
#layout_canvas {
	...
	background:url('<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/contentbg.jpg');border-bottom:1px solid #cccccc;
...
#menu a {
	...
	font-weight: bold;
	font-size: 0.9em;
	background:transparent url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/menu_button_left.gif) no-repeat left top;
}
#menu a span {
	float:left;
	display:block;
	...
	margin:0 0 0 0;
	color:#ffffff;
	background:transparent url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/menu_button_right.gif) no-repeat right top;
}
#menu_inner a span { cursor: pointer; }
#menu a.disabled span { color:#000033; }
#menu a.disabled { color:#000033; }
#menu a.disabled:hover { color:#000033; }
#menu a.disabled:hover span { color:#000033; }

#menu a:hover span {
	color:white;
	background:transparent url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/menu_button_right.gif) no-repeat right -32px;
	padding:3px 13px 0px 6px;
	height:22px;
}
#menu a:hover {
	color:white;
	background:transparent url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/menu_button_left.gif) no-repeat left -32px;
}
#menu a.selected {
	background:transparent url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/menu_button_left.gif) no-repeat left -32px;
}
...
#two_column_left_sidebar {
	...
	min-height:360px;
	float:left;
	background: white url('<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/contentbg.png');padding:0px;
	-webkit-border-radius: 8px; 
	-moz-border-radius: 8px;
...
#two_column_left_sidebar_boxes .sidebarBox h3 {
	...
	font-size:1.25em;
	line-height:1.2em;
	color:#000000;   /* Miembros recientes */
}
#two_column_left_sidebar_boxes .sidebarBox h3 {
	padding:0 0 5px 0;
	font-size:1.25em;
...
.contentWrapper {
	background:white;    /* Fondo del muro */
	-webkit-border-radius: 8px; 
	-moz-border-radius: 8px;
    padding:10px;
...
*************************************** */
#elgg_topbar {
	background: transparent url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/page_header.jpg) repeat-x top left;
    color:#000000;
	position:relative;
	width:100%;
	margin: auto;
...
*+html #elgg_topbar_container_left a.privatemessages_new { background-position: left -18px; } 
	...
	color:#eeeeee;
	margin:0 5px 0 0;
	background:transparent url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/elgg_toolbar_logout.png) no-repeat top right;padding:0 21px 0 0;
	display:block;
	height:20px;
}
#elgg_topbar_container_reg {
...
#elgg_topbar_container_reg a {
	color:#eeeeee;
	margin:0 5px 0 0;
	background:transparent url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/elgg_toolbar_reg.png) no-repeat top right;padding:0 21px 0 0;
	display:block;
	height:20px;
}
/* IE6 fix */
...
* html #elgg_topbar_container_reg a { 
	width: 120px;
}
#elgg_topbar_container_reg a:hover {
	background-position: right -21px;
}
#elgg_topbar_panel {
	background:#333333;
...
#owner_block_submenu ul li.selected a {
	color:#DEDEDE;
	background: url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/owner_block_menu_arrow.gif) no-repeat left 6px;
	padding-left:10px;
}
...
div.ajax_loader {
	background: white url(<?php echo $vars['url']; ?>mod/FEIBook_Theme/graphics/ajax_loader.gif) no-repeat center 30px;
	width:auto;
	height:100px;
	margin:0 10px 0 10px;
	-webkit-border-radius: 8px; 
