<?php
    ...
    echo elgg_view('input/text', array('internalname' => "params[width]", 'value' => $vars['entity']->width, 'class' => ' '));
	echo '</p>';
	echo '<p>';
	echo elgg_echo('embed_extender:widget_width');
    echo elgg_view('input/text', array('internalname' => "params[widget_width]", 'value' => $vars['entity']->widget_width, 'class' => ' '));
	echo '</p>';
    ...
    echo elgg_view('input/pulldown', array(
            'internalname' => 'params[comment_show]',
            'options_values' => array(
			    'yes' => elgg_echo('option:yes'),
                'no' => elgg_echo('option:no')
            ),
    ...
    echo elgg_view('input/pulldown', array(
            'internalname' => 'params[topicposts_show]',
            'options_values' => array(
			    'yes' => elgg_echo('option:yes'),
                'no' => elgg_echo('option:no')
            ),
    ...
    echo elgg_view('input/pulldown', array(
            'internalname' => 'params[messageboard_show]',
            'options_values' => array(
			    'yes' => elgg_echo('option:yes'),
                'no' => elgg_echo('option:no')
            ),
    ...
    echo elgg_view('input/pulldown', array(
            'internalname' => 'params[custom_provider]',
            'options_values' => array(
			    'yes' => elgg_echo('option:yes'),
                'no' => elgg_echo('option:no')
            ),
