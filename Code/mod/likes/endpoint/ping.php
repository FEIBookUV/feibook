...
//	echo elgg_view("likes/item_action", array('entity' => $entity, 'item' => $item, 'callback' => $callback));

	$data['status'] = elgg_view("input/$action_name", array(
		'entity' => $entity, 
		'item' => $item, 
		'callback' => $callback,
	));
	...
	set_input('like_action', true);
	$data['button'] = elgg_view("likes/item_action/element", array(
		'entity' => $entity,
		'item' => $item,
	 	'callback' => $callback,
